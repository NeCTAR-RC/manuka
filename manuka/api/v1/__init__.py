...
from manuka.api.v1.resources import invitation
...
def initialize_resources(api):
    ...
    api.add_resource(invitation.InvitationList, '/v1/invitations/')
    api.add_resource(invitation.Invitation, '/v1/invitations/<id>/')
